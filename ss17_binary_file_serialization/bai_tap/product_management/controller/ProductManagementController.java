...
import ss16_binary_file_serialization.bai_tap.product_management.model.service.IProductManagementServiceImpl;

import java.util.List;

public class ProductManagementController {
    private final IProductManagementService productManagementService = new IProductManagementServiceImpl();
